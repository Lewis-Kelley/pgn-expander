...
validPawnMove :: GameState -> Color -> (Int, Int) -> (Int, Int) -> Bool
...
validDoubleMove :: GameState -> Color -> (Int, Int) -> (Int, Int) -> Bool
...
validSingleMove :: GameState -> Color -> (Int, Int) -> (Int, Int) -> Bool
